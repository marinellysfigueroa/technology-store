...
public class ControladorGarantiaTest {
    ...
    public void generarGarantiaProducto() throws Exception
    {
        ...
        mvc.perform( MockMvcRequestBuilders
                .post("/garantia/{idProducto}/{nombreCliente}",comandoProducto.getCodigo(),"CLIENTE")
    ...
    @Test
    public void getGarantiaPorId() throws Exception
    {
        mvc.perform( MockMvcRequestBuilders
                .get("/garantia/{id}", "PROD_001")
                .accept(MediaType.APPLICATION_JSON))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.nombreCliente").value("Felipe"));
    }
}
